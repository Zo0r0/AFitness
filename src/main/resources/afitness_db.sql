...
add foreign key fk_clients(client_membership_id) references memberships(membership_id);

alter table afitness_db.clients
add foreign key fk_users(client_user_id) references users(user_id);

alter table afitness_db.users
add foreign key fk_users(role_id) references roles(role_id);
...
client_membership_expiration) values
('Zoë','Jadi', '8684623', 'Granmankondrestraat 9', '1998-01-25', 'T', 3, '2020-12-01'),
('Taufiq','Sultan', '8755964', 'Keizerstraat 10', '1998-02-14', 'T', 2, '2020-08-07'),
('Matthew','Sahit', '845632', 'Leiding 9a 13', '2000-06-21', 'T', 1, '2020-07-03'),
('Shivan','Sewdien', '784266', 'Leiding 10 25', '1998-11-11', 'T', 1, '2020-03-03');
